...
#
# Created: Fri Jul  4 16:04:29 2014
...
class Ui_QgsWcsClient2(object):
    def setupUi(self, QgsWcsClient2):
        ...
        QgsWcsClient2.resize(799, 678)
        self.tabWidget_EOWcsClient2 = QtGui.QTabWidget(QgsWcsClient2)
        self.tabWidget_EOWcsClient2.setGeometry(QtCore.QRect(10, 10, 781, 651))
        ...
        self.btnTestServer_Serv = QtGui.QPushButton(self.GroupBox_9)
        self.btnTestServer_Serv.setEnabled(True)
        self.btnTestServer_Serv.setObjectName(_fromUtf8("btnTestServer_Serv"))
        self._6.addWidget(self.btnTestServer_Serv, 1, 0, 1, 1)
        ...
        self._6.addWidget(self.cmbConnections_Serv, 0, 0, 1, 6)
        ...
        self.textBrowser_Serv.setGeometry(QtCore.QRect(20, 160, 731, 191))
        self.textBrowser_Serv.setObjectName(_fromUtf8("textBrowser_Serv"))
        self.btnClose_Serv = QtGui.QPushButton(self.tab_Serv)
        self.btnClose_Serv.setGeometry(QtCore.QRect(650, 570, 98, 27))
        ...
        self.GroupBox_4.setGeometry(QtCore.QRect(9, 30, 741, 111))
        self.GroupBox_4.setObjectName(_fromUtf8("GroupBox_4"))
        self.gridLayoutWidget_3 = QtGui.QWidget(self.GroupBox_4)
        self.gridLayoutWidget_3.setGeometry(QtCore.QRect(10, 20, 651, 81))
        ...
        self.label_GCsInfo1 = QtGui.QLabel(self.GroupBox_5)
        self.label_GCsInfo1.setGeometry(QtCore.QRect(10, 6, 241, 31))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.label_GCsInfo1.setFont(font)
        self.label_GCsInfo1.setObjectName(_fromUtf8("label_GCsInfo1"))
        self.dateEdit_GCaDocUpdate = QtGui.QDateEdit(self.GroupBox_5)
        self.dateEdit_GCaDocUpdate.setGeometry(QtCore.QRect(250, 6, 131, 27))
        self.dateEdit_GCaDocUpdate.setDate(QtCore.QDate(2014, 1, 1))
        self.dateEdit_GCaDocUpdate.setMinimumDateTime(QtCore.QDateTime(QtCore.QDate(1752, 9, 14), QtCore.QTime(0, 0, 0)))
        ...
        self.treeWidget_GCa.setGeometry(QtCore.QRect(10, 220, 762, 341))
        ...
        self.treeWidget_DC.setGeometry(QtCore.QRect(10, 76, 762, 471))
        self.treeWidget_DC.setColumnCount(4)
        ...
        self.label_DCSInfo2.setGeometry(QtCore.QRect(29, 44, 661, 16))
        ...
        self.treeWidget_DCS.setGeometry(QtCore.QRect(10, 70, 762, 211))
        self.treeWidget_DCS.setColumnCount(4)
        ...
        self.label_DCSMinLon.setEnabled(True)
        ...
        self.groupBox_12.setGeometry(QtCore.QRect(20, 516, 391, 91))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.dateTimeEdit_DCSBegin.setGeometry(QtCore.QRect(121, 21, 194, 27))
        self.dateTimeEdit_DCSBegin.setLocale(QtCore.QLocale(QtCore.QLocale.English, QtCore.QLocale.UnitedStates))
        self.dateTimeEdit_DCSBegin.setDateTime(QtCore.QDateTime(QtCore.QDate(2013, 12, 31), QtCore.QTime(17, 0, 0)))
        self.dateTimeEdit_DCSBegin.setDate(QtCore.QDate(2013, 12, 31))
        self.dateTimeEdit_DCSBegin.setMinimumDateTime(QtCore.QDateTime(QtCore.QDate(1752, 10, 12), QtCore.QTime(17, 0, 0)))
        self.dateTimeEdit_DCSBegin.setMinimumTime(QtCore.QTime(17, 0, 0))
        ...
        self.dateTimeEdit_DCSEnd.setGeometry(QtCore.QRect(121, 61, 194, 27))
        self.dateTimeEdit_DCSEnd.setDateTime(QtCore.QDateTime(QtCore.QDate(2014, 1, 2), QtCore.QTime(16, 59, 59)))
        self.dateTimeEdit_DCSEnd.setDate(QtCore.QDate(2014, 1, 2))
        self.dateTimeEdit_DCSEnd.setTime(QtCore.QTime(16, 59, 59))
        self.dateTimeEdit_DCSEnd.setMinimumDateTime(QtCore.QDateTime(QtCore.QDate(1752, 10, 12), QtCore.QTime(17, 0, 0)))
        self.dateTimeEdit_DCSEnd.setMaximumTime(QtCore.QTime(16, 59, 59))
        ...
        self.label_DCSBegin.setGeometry(QtCore.QRect(11, 25, 111, 20))
        self.label_DCSBegin.setObjectName(_fromUtf8("label_DCSBegin"))
        self.label_DCSEnd = QtGui.QLabel(self.groupBox_12)
        self.label_DCSEnd.setGeometry(QtCore.QRect(11, 64, 111, 20))
        ...
        self.groupBox_14.setGeometry(QtCore.QRect(568, 390, 121, 71))
        self.groupBox_14.setObjectName(_fromUtf8("groupBox_14"))
        self.spinBox_DCSCount = QtGui.QSpinBox(self.groupBox_14)
        self.spinBox_DCSCount.setGeometry(QtCore.QRect(18, 30, 101, 27))
        self.spinBox_DCSCount.setMinimum(1)
        self.spinBox_DCSCount.setMaximum(99999)
        self.spinBox_DCSCount.setProperty("value", 100)
        ...
        self.checkBox_DCCovSum = QtGui.QCheckBox(self.gridLayoutWidget_5)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Maximum, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.checkBox_DCCovSum.sizePolicy().hasHeightForWidth())
        self.checkBox_DCCovSum.setSizePolicy(sizePolicy)
        self.checkBox_DCCovSum.setObjectName(_fromUtf8("checkBox_DCCovSum"))
        self.gridLayout_6.addWidget(self.checkBox_DCCovSum, 0, 2, 1, 1)
        ...
        self.label_GCOvInfo2.setGeometry(QtCore.QRect(43, 46, 661, 16))
        self.label_GCOvInfo2.setObjectName(_fromUtf8("label_GCOvInfo2"))
        self.groupBox_15 = QtGui.QGroupBox(self.tab_GCov)
        self.groupBox_15.setGeometry(QtCore.QRect(20, 260, 401, 271))
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        ...
        self.groupBox_16.setGeometry(QtCore.QRect(0, 120, 381, 151))
        ...
        self.label_GCovMaxLon.setScaledContents(False)
        ...
        self.label_GCovMinLon.setEnabled(True)
        ...
        self.groupBox_17.setGeometry(QtCore.QRect(2, 20, 411, 91))
        font = QtGui.QFont()
        ...
        self.radioButton_GCovSubOrig.setGeometry(QtCore.QRect(20, 20, 116, 22))
        ...
        self.radioButton_GCovSubCRS.setGeometry(QtCore.QRect(153, 20, 81, 22))
        ...
        self.radioButton_GCovSubPixel.setGeometry(QtCore.QRect(270, 20, 71, 22))
        ...
        self.lineEdit_GCovSubEPSG.setGeometry(QtCore.QRect(140, 62, 111, 27))
        ...
        self.label_GCovSubEPSG.setGeometry(QtCore.QRect(161, 41, 66, 17))
        self.label_GCovSubEPSG.setObjectName(_fromUtf8("label_GCovSubEPSG"))
        self.lineEdit_GCovBands = QtGui.QLineEdit(self.tab_GCov)
        self.lineEdit_GCovBands.setGeometry(QtCore.QRect(113, 539, 211, 27))
        self.lineEdit_GCovBands.setObjectName(_fromUtf8("lineEdit_GCovBands"))
        self.label_GCOvBands = QtGui.QLabel(self.tab_GCov)
        self.label_GCOvBands.setGeometry(QtCore.QRect(25, 543, 66, 17))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.label_GCOvBands.setFont(font)
        self.label_GCOvBands.setObjectName(_fromUtf8("label_GCOvBands"))
        self.label_GCovOutCRS = QtGui.QLabel(self.tab_GCov)
        self.label_GCovOutCRS.setGeometry(QtCore.QRect(23, 583, 171, 20))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.label_GCovOutCRS.setFont(font)
        self.label_GCovOutCRS.setObjectName(_fromUtf8("label_GCovOutCRS"))
        self.lineEdit_GCovOutCRS = QtGui.QLineEdit(self.tab_GCov)
        self.lineEdit_GCovOutCRS.setGeometry(QtCore.QRect(200, 580, 121, 27))
        self.lineEdit_GCovOutCRS.setObjectName(_fromUtf8("lineEdit_GCovOutCRS"))
        self.label_GCovOutFormat = QtGui.QLabel(self.tab_GCov)
        self.label_GCovOutFormat.setGeometry(QtCore.QRect(498, 273, 141, 20))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.label_GCovOutFormat.setFont(font)
        self.label_GCovOutFormat.setObjectName(_fromUtf8("label_GCovOutFormat"))
        self.comboBox_GCOvOutFormat = QtGui.QComboBox(self.tab_GCov)
        self.comboBox_GCOvOutFormat.setGeometry(QtCore.QRect(624, 270, 131, 27))
        self.comboBox_GCOvOutFormat.setObjectName(_fromUtf8("comboBox_GCOvOutFormat"))
        self.label_GCovInterpol = QtGui.QLabel(self.tab_GCov)
        self.label_GCovInterpol.setGeometry(QtCore.QRect(500, 320, 111, 17))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.label_GCovInterpol.setFont(font)
        self.label_GCovInterpol.setObjectName(_fromUtf8("label_GCovInterpol"))
        self.comboBox_GCovInterpol = QtGui.QComboBox(self.tab_GCov)
        self.comboBox_GCovInterpol.setGeometry(QtCore.QRect(614, 317, 141, 27))
        ...
        QtCore.QObject.connect(self.btnTestServer_Serv, QtCore.SIGNAL(_fromUtf8("clicked()")), QgsWcsClient2.testServer)
    ...
    def retranslateUi(self, QgsWcsClient2):
        ...
        self.btnTestServer_Serv.setText(_translate("QgsWcsClient2", "&Test the Server", None))
        ...
        self.tabWidget_EOWcsClient2.setTabText(self.tabWidget_EOWcsClient2.indexOf(self.tab_Serv), _translate("QgsWcsClient2", "Server ", None))
        ...
        self.label_GCsInfo1.setText(_translate("QgsWcsClient2", "Document UpdateSequence - \n"
"only update when newer then:", None))
        ...
        self.treeWidget_GCa.headerItem().setText(0, _translate("QgsWcsClient2", "Choice", None))
        self.treeWidget_GCa.headerItem().setText(1, _translate("QgsWcsClient2", "Identifier", None))
        self.treeWidget_GCa.headerItem().setText(2, _translate("QgsWcsClient2", "Title", None))
        self.treeWidget_GCa.headerItem().setText(3, _translate("QgsWcsClient2", "Abstract", None))
        ...
        self.treeWidget_DC.headerItem().setText(0, _translate("QgsWcsClient2", "Choice", None))
        self.treeWidget_DC.headerItem().setText(1, _translate("QgsWcsClient2", "Identifier", None))
        self.treeWidget_DC.headerItem().setText(2, _translate("QgsWcsClient2", "Title", None))
        self.treeWidget_DC.headerItem().setText(3, _translate("QgsWcsClient2", "Abstract", None))
        ...
        self.label_DCSInfo2.setText(_translate("QgsWcsClient2", "Select the ID\'s of interest, choose AOI and TOI, then press the DescribeEOCoverageSet button.", None))
        ...
        self.treeWidget_DCS.headerItem().setText(0, _translate("QgsWcsClient2", "Choice", None))
        self.treeWidget_DCS.headerItem().setText(1, _translate("QgsWcsClient2", "Identifier", None))
        self.treeWidget_DCS.headerItem().setText(2, _translate("QgsWcsClient2", "Title", None))
        self.treeWidget_DCS.headerItem().setText(3, _translate("QgsWcsClient2", "Abstract", None))
...
"Longitude", None))
        ...
        self.checkBox_DCCovSum.setText(_translate("QgsWcsClient2", "CoverageSummary", None))
        ...
        self.treeWidget_GCov.headerItem().setText(0, _translate("QgsWcsClient2", "Choice", None))
        self.treeWidget_GCov.headerItem().setText(1, _translate("QgsWcsClient2", "Identifier", None))
        self.treeWidget_GCov.headerItem().setText(2, _translate("QgsWcsClient2", "Title", None))
        self.treeWidget_GCov.headerItem().setText(3, _translate("QgsWcsClient2", "Abstract", None))
        self.label_GCovInfo1.setText(_translate("QgsWcsClient2", "GetCoverage:   download a Coverage ", None))
        self.label_GCOvInfo2.setText(_translate("QgsWcsClient2", "Select the ID\'s of interest, then press the GetCoverager button.", None))
...
"Longitude", None))
        ...
        self.label_GCOvBands.setText(_translate("QgsWcsClient2", "Bands:", None))
        self.label_GCovOutCRS.setText(_translate("QgsWcsClient2", "Output CRS (EPSG) No:", None))
        ...
        self.tabWidget_EOWcsClient2.setTabText(self.tabWidget_EOWcsClient2.indexOf(self.tab_Help), _translate("QgsWcsClient2", "About / Help", None))
