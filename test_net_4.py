...
#        data = self.reply.ReadAll(buffer_size).data()
#        print 'HHH: ', help(data)
#        print "DDD: ", data
        self.downloaded_file_buffer.append(data)

    def write_data(self):
        print 'FD-333: write to file'
        """Write data to a file."""
#        print "EEE: ", self.downloaded_file_buffer
#        print self.output_file
        print self.downloaded_file_buffer
